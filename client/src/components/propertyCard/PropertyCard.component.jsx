...
//         <PropertyCardView 
//             functions={{handleLikes, getUserLikes,updateImageLink, imageKey, handlePropClick,getPhoto,getStatusStyle,cleanInput,formatNumber,likeProperty,handleForRent}} 
