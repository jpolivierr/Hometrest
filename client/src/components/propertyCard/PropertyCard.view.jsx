...
const PropertyCardView = ({functions, propertyDetails, value}) =>{
    ...
    const {getUserLikes, handleForRent,handlePropClick,getPhoto,getStatusStyle,cleanInput,formatNumber,likeProperty} = functions
    ...
    return(
        ...
        <>
            ...
            <div className="prop-info">
                    ...
                    {!getUserLikes(propertyId) ? <i onClick={()=>likeProperty(propertyId)} className="fa-regular fa-heart"></i> : <i onClick={()=>likeProperty(propertyId)} className="fa-solid fa-heart like-prop"></i>}
