...
const PropertyCardView = ({functions, propertyDetails}) =>{

    const {handleForRent,handlePropClick,getPhoto,getStatusStyle,cleanInput,formatNumber,likeProperty} = functions
